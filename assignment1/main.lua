...
function love.draw()
	...
	if GameInPause then
		local pauseWidth, pauseHeight = pauseIcon:getDimensions()
		love.graphics.draw(pauseIcon, VIRTUAL_WIDTH/2 - pauseWidth/2, VIRTUAL_HEIGHT/2 - pauseHeight/2)
	else
